...
import com.imgurujeet.todolist.todoApp.ui.theme.LightAppColors
import com.imgurujeet.todolist.todoApp.ui.theme.appColors
        ...
        Canvas(
            ...
            translate(top = -2f) {
                drawPath(
                    ...
                    else LightAppColors.dark.copy(alpha = 0.5f),
                    style = Fill
                )
            }
        }
...
data class CurvedButtonConfig (
    val containerColor: Color = LightAppColors.primary,
    val contentColor : Color = LightAppColors.light,
    val fontSize : TextUnit = 18.sp,
    val gradientShadowColor : Color = LightAppColors.primary.copy(alpha = 0.4f),
